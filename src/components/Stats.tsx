...
export const Stats: React.FC<StatsProps> = ({
  ...
  if (compact) {
    return (
      <section className="shrink-0 grid grid-cols-3 gap-2 text-center">
        <div>
          <p className="text-[10px] uppercase tracking-widest text-zinc-500 flex items-center justify-center gap-1">
        ...
        <div>
          ...
          <p className="text-sm font-mono text-white tabular-nums">{tokensCount}</p>
        </div>
        <div>
  ...
  return (
    <section className="bg-zinc-900/50 border border-white/5 rounded-2xl p-6 grid grid-cols-2 gap-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-2xl font-mono font-medium text-white">{tokensCount}</p>
      </div>
      <div className="col-span-2 pt-4 border-t border-white/5 space-y-1">
        ...
        <div className="flex items-baseline gap-2">
          <p className="text-4xl font-mono font-bold text-emerald-400">{currentSpeed}</p>
